					...
					$.ajax({
						...
						success: function(msg) {
							if (msg.status === 1) {
								...
								$form.find('.submit-status').html('<div class="submit-status-txt"><span class="success"><i class="ion ion-ios-checkmark-outline"></i> ' + msg.data.message + '</span></div>').fadeIn(300).delay(3000).fadeOut(300);
							} else {
								...
								$submit.removeAttr('disabled');
								$form.find('.submit-status').html('<div class="submit-status-txt"><span class="error"><i class="ion ion-ios-close-outline"></i> ' + msg.data.message + '</span></div>').fadeIn(300).delay(3000).fadeOut(300);
							}
							// if (parseInt(msg, 0) !== 0) {
							...
							if (xhr.status == 422) {
								...
								for (var key in data) {
									if (data.hasOwnProperty(key)) {
										html += '<span class="error"><i class="ion ion-ios-close-outline"></i> ' + data[key][0] + '</span><br/>';
									}
								}
								...
								//$send_copy.removeAttr('disabled');
								$submit.removeAttr('disabled');
								$form.find('.submit-status').html('<div class="submit-status-txt">' + html + '</div>').fadeIn(300).delay(3000).fadeOut(300);
							}
						}
					});
				}
