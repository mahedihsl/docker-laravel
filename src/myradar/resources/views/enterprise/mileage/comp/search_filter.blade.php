<form class="mileage-form" action="/enterprise/mileage/record" method="get">
    <div class="row">
        <div class="col-sm-2">
        ...
        <div class="col-sm-2">
            ...
            <a class="btn btn-sm btn-default" href="/enterprise/mileage/report"><i class="fa fa-refresh fa-1x"></i></a>
        </div>
    </div>
</form>
