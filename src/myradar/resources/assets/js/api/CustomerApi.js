...
export default class CustomerApi {
    ...
    info(id) {
        Vue.http.get(`/customer/info/${id}`).then(
            response => {
    ...
    data(id) {
        Vue.http.get(`/customer/data/${id}`).then(
            response => {
    ...
    getSettings(id) {
        Vue.http.get(`/customer/settings/${id}`).then(
            response => {
                this.EventBus.$emit(
    ...
    updateSettings(data) {
        Vue.http.post(`/customer/settings/change`, data).then(
            response => {
    ...
    cars(userId) {
        Vue.http.get(`/user/car/names/${userId}`).then(
            response => {
                this.EventBus.$emit("car-names-found", response.data);
            },
            error => {}
        );
    }
    ...
    customerIds() {
        Vue.http.get(`/customer/ids`).then(
            response => {
