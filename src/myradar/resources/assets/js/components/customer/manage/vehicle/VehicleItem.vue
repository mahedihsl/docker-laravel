<template>
    <tr class="car-item" :class="{ focused }">
        <td>
            ...
            <span class="label label-success" v-if="!!state && state.shared"
                >Shared</span
            >
        </td>
        <td>
        ...
        <td>
            <span
                class="right-space"
                :class="{
                    'text-success': vehicle.status,
                    'text-danger': !vehicle.status
                }"
            >
